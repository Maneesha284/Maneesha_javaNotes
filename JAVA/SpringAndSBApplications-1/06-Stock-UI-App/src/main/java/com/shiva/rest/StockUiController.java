...
import com.shiva.service.StockUiService;
...
public class StockUiController {
	...
	public String getTotalCost(HttpServletRequest req,Model model)
	{
		...
		String quanity=req.getParameter("quantity");
		String response=service.getTotalStockPrice(companyName, Integer.parseInt(quanity));
